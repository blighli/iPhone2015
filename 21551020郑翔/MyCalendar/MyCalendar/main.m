...
//  MyCalendar
//
//  Created by zhengxiang on 15/10/15.
...
//void show(NSUInteger year, NSUInteger month)
//{
//    NSCalendar *calendar = [NSCalendar currentCalendar];
//    //[calendar ]
//    NSDateComponents *compt = [[NSDateComponents alloc] init];
...
//    NSUInteger week = [compt weekday];
//    NSUInteger firstDayOfMonth = week - day%7 + 1;
//    //NSLog(@"firstDayOfMonth = %lu", firstDayOfMonth);
//
//    NSRange range = [calendar rangeOfUnit:NSCalendarUnitDay inUnit:NSCalendarUnitMonth forDate:date];
//    NSUInteger dayCount = range.length;
//    //NSLog(@"%lu", dayCount);
...
//        printf("   ");
//    }
//    NSUInteger cnt = firstDayOfMonth;
...
//                {
//                    //if (cnt[t] == arrDayCount[month + t]) continue;
//
//                    if (j == 1 || cnt[t] == 1)
//                    {
//                        if (cnt[t] > arrDayCount[month + t])
