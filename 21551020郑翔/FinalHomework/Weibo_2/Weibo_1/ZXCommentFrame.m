...
@implementation ZXCommentFrame

- (void)setComment:(ZXComment *)comment
{
    _comment = comment;
    ...
    NSString *commentdate = comment.comment_date;
    NSLog(@"%@", nickName);
    ...
    CGSize dateSize = [self sizeWithText:commentdate andMaxSize:CGSizeMake(MAXFLOAT, MAXFLOAT) andFont:dateFont];
    ...
    CGSize textSize = [self sizeWithText:comment.text andMaxSize:CGSizeMake(355, MAXFLOAT) andFont:textFont];
    ...
    CGFloat rowHeight = 0;
    if (self.comment.picture.length > 0) {
