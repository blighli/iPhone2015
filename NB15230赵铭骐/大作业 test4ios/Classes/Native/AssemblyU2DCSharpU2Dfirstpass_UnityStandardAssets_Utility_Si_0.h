...
struct  SimpleMouseRotator_t111  : public MonoBehaviour_t2
{
	// UnityEngine.Vector2 UnityStandardAssets.Utility.SimpleMouseRotator::rotationRange
	Vector2_t6  ___rotationRange_2;
	...
	Quaternion_t19  ___m_OriginalRotation_11;
};
