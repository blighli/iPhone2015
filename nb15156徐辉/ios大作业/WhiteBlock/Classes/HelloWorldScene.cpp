...
bool HelloWorld::init()
{
    ...
    listener->onTouchBegan = [this](Touch* t,Event* e){
        ...
        for(auto it = bs->begin(); it!=bs->end(); it++){
            b = *it;
            if (b->getLineIndex()==1 && b->getBoundingBox().containsPoint(t->getLocation())) {//和触摸点相碰撞
...
void HelloWorld::addStartLine(){
    auto b = Block::createWithArgs(Color3B::YELLOW, Size(visibleSize.width, visibleSize.height/4), "startline", 20, Color4B::BLACK);
