        ...
        switch (argc) {
            ...
            case 2:{
                ...
                for(i=1;i<=12;){
                    ...
                    printf("wxh_cal: year 0 not in range 1..9999\n");
                break;
...
//                 sscanf(argv[2],"%d",&month);
               ...
               // bool b=[s isEqualToString:@"-m"];
                if(strcmp(argv[1],"-m")==0){
                    ...
                    sscanf(argv[2],"%d",&month);
                    if(month>12||month<1){
                        printf("wxh_cal: %d is neither a month number (1..12) nor a name\n",month);
                        break;
                ...
                sscanf(argv[2], "%d",&year);
                    if(!(month<=12&&month>=1)){
                        printf("wxh_cal: illegal option -%s\n",argv[1]);
                        printf("usage: wxh_cal  [[month] year]\n");
                        printf("       wxh_cal  [-m month] [year]\n");
                        break;
