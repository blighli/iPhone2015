...
#define DLL_EXPORT __declspec(dllexport)
	...
	DECL_USER_FUNC(aruRequestCamera);
	DECL_USER_FUNC(arwRegisterLogCallback);
	DECL_USER_FUNC(arwInitialiseAR);
	DECL_USER_FUNC(arwInitialiseARWithOptions);
	DECL_USER_FUNC(arwGetARToolKitVersion);
	DECL_USER_FUNC(arwGetError);
	DECL_USER_FUNC(arwShutdownAR);
	DECL_USER_FUNC(arwStartRunningB);
	DECL_USER_FUNC(arwStartRunningStereoB);
	DECL_USER_FUNC(arwIsRunning);
	DECL_USER_FUNC(arwStopRunning);
	DECL_USER_FUNC(arwGetProjectionMatrix);
	DECL_USER_FUNC(arwGetProjectionMatrixStereo);
	DECL_USER_FUNC(arwGetVideoParams);
	DECL_USER_FUNC(arwGetVideoParamsStereo);
	DECL_USER_FUNC(arwCapture);
	DECL_USER_FUNC(arwUpdateAR);
	DECL_USER_FUNC(arwUpdateTexture);
	DECL_USER_FUNC(arwUpdateTextureStereo);
	DECL_USER_FUNC(arwUpdateTexture32);
	DECL_USER_FUNC(arwUpdateTexture32Stereo);
	DECL_USER_FUNC(arwUpdateTextureGL);
	DECL_USER_FUNC(arwUpdateTextureGLStereo);
	DECL_USER_FUNC(arwSetUnityRenderEventUpdateTextureGLTextureID);
	DECL_USER_FUNC(arwSetUnityRenderEventUpdateTextureGLStereoTextureIDs);
	DECL_USER_FUNC(arwGetMarkerPatternCount);
	DECL_USER_FUNC(arwGetMarkerPatternConfig);
	DECL_USER_FUNC(arwGetMarkerPatternImage);
	DECL_USER_FUNC(arwGetMarkerOptionBool);
	DECL_USER_FUNC(arwSetMarkerOptionBool);
	DECL_USER_FUNC(arwGetMarkerOptionInt);
	DECL_USER_FUNC(arwSetMarkerOptionInt);
	DECL_USER_FUNC(arwGetMarkerOptionFloat);
	DECL_USER_FUNC(arwSetMarkerOptionFloat);
	DECL_USER_FUNC(arwSetVideoDebugMode);
	DECL_USER_FUNC(arwGetVideoDebugMode);
	DECL_USER_FUNC(arwSetVideoThreshold);
	DECL_USER_FUNC(arwGetVideoThreshold);
	DECL_USER_FUNC(arwSetVideoThresholdMode);
	DECL_USER_FUNC(arwGetVideoThresholdMode);
	DECL_USER_FUNC(arwSetLabelingMode);
	DECL_USER_FUNC(arwGetLabelingMode);
	DECL_USER_FUNC(arwSetBorderSize);
	DECL_USER_FUNC(arwGetBorderSize);
	DECL_USER_FUNC(arwSetPatternDetectionMode);
	DECL_USER_FUNC(arwGetPatternDetectionMode);
	DECL_USER_FUNC(arwSetMatrixCodeType);
	DECL_USER_FUNC(arwGetMatrixCodeType);
	DECL_USER_FUNC(arwSetImageProcMode);
	DECL_USER_FUNC(arwGetImageProcMode);
	DECL_USER_FUNC(arwSetNFTMultiMode);
	DECL_USER_FUNC(arwGetNFTMultiMode);
	DECL_USER_FUNC(arwAddMarker);
	DECL_USER_FUNC(arwRemoveMarker);
	DECL_USER_FUNC(arwRemoveAllMarkers);
	DECL_USER_FUNC(arwQueryMarkerVisibility);
	DECL_USER_FUNC(arwQueryMarkerTransformation);
	DECL_USER_FUNC(arwQueryMarkerTransformationStereo);
	DECL_USER_FUNC(arwLoadOpticalParams);
	DECL_USER_FUNC(ReAllocTexture);
	DECL_USER_FUNC(OpenStream);
	DECL_USER_FUNC(GetPicWidth);
	DECL_USER_FUNC(GetPicHeight);
	DECL_USER_FUNC(GetPicX);
	DECL_USER_FUNC(GetPicY);
	DECL_USER_FUNC(DecodeFrame);
	DECL_USER_FUNC(GetYStride);
	DECL_USER_FUNC(GetYHeight);
	DECL_USER_FUNC(GetUVStride);
	DECL_USER_FUNC(GetUVHeight);
	DECL_USER_FUNC(DecodeAndUpload);
	DECL_USER_FUNC(GetPlane);
	DECL_USER_FUNC(GetNextFrameTime);
	DECL_USER_FUNC(CloseStream);
	DECL_USER_FUNC(GetAspectRatio);
}
DLL_EXPORT void RegisterMonoModules()
{
	...
	REGISTER_USER_FUNC(aruRequestCamera);
	REGISTER_USER_FUNC(arwRegisterLogCallback);
	REGISTER_USER_FUNC(arwInitialiseAR);
	REGISTER_USER_FUNC(arwInitialiseARWithOptions);
	REGISTER_USER_FUNC(arwGetARToolKitVersion);
	REGISTER_USER_FUNC(arwGetError);
	REGISTER_USER_FUNC(arwShutdownAR);
	REGISTER_USER_FUNC(arwStartRunningB);
	REGISTER_USER_FUNC(arwStartRunningStereoB);
	REGISTER_USER_FUNC(arwIsRunning);
	REGISTER_USER_FUNC(arwStopRunning);
	REGISTER_USER_FUNC(arwGetProjectionMatrix);
	REGISTER_USER_FUNC(arwGetProjectionMatrixStereo);
	REGISTER_USER_FUNC(arwGetVideoParams);
	REGISTER_USER_FUNC(arwGetVideoParamsStereo);
	REGISTER_USER_FUNC(arwCapture);
	REGISTER_USER_FUNC(arwUpdateAR);
	REGISTER_USER_FUNC(arwUpdateTexture);
	REGISTER_USER_FUNC(arwUpdateTextureStereo);
	REGISTER_USER_FUNC(arwUpdateTexture32);
	REGISTER_USER_FUNC(arwUpdateTexture32Stereo);
	REGISTER_USER_FUNC(arwUpdateTextureGL);
	REGISTER_USER_FUNC(arwUpdateTextureGLStereo);
	REGISTER_USER_FUNC(arwSetUnityRenderEventUpdateTextureGLTextureID);
	REGISTER_USER_FUNC(arwSetUnityRenderEventUpdateTextureGLStereoTextureIDs);
	REGISTER_USER_FUNC(arwGetMarkerPatternCount);
	REGISTER_USER_FUNC(arwGetMarkerPatternConfig);
	REGISTER_USER_FUNC(arwGetMarkerPatternImage);
	REGISTER_USER_FUNC(arwGetMarkerOptionBool);
	REGISTER_USER_FUNC(arwSetMarkerOptionBool);
	REGISTER_USER_FUNC(arwGetMarkerOptionInt);
	REGISTER_USER_FUNC(arwSetMarkerOptionInt);
	REGISTER_USER_FUNC(arwGetMarkerOptionFloat);
	REGISTER_USER_FUNC(arwSetMarkerOptionFloat);
	REGISTER_USER_FUNC(arwSetVideoDebugMode);
	REGISTER_USER_FUNC(arwGetVideoDebugMode);
	REGISTER_USER_FUNC(arwSetVideoThreshold);
	REGISTER_USER_FUNC(arwGetVideoThreshold);
	REGISTER_USER_FUNC(arwSetVideoThresholdMode);
	REGISTER_USER_FUNC(arwGetVideoThresholdMode);
	REGISTER_USER_FUNC(arwSetLabelingMode);
	REGISTER_USER_FUNC(arwGetLabelingMode);
	REGISTER_USER_FUNC(arwSetBorderSize);
	REGISTER_USER_FUNC(arwGetBorderSize);
	REGISTER_USER_FUNC(arwSetPatternDetectionMode);
	REGISTER_USER_FUNC(arwGetPatternDetectionMode);
	REGISTER_USER_FUNC(arwSetMatrixCodeType);
	REGISTER_USER_FUNC(arwGetMatrixCodeType);
	REGISTER_USER_FUNC(arwSetImageProcMode);
	REGISTER_USER_FUNC(arwGetImageProcMode);
	REGISTER_USER_FUNC(arwSetNFTMultiMode);
	REGISTER_USER_FUNC(arwGetNFTMultiMode);
	REGISTER_USER_FUNC(arwAddMarker);
	REGISTER_USER_FUNC(arwRemoveMarker);
	REGISTER_USER_FUNC(arwRemoveAllMarkers);
	REGISTER_USER_FUNC(arwQueryMarkerVisibility);
	REGISTER_USER_FUNC(arwQueryMarkerTransformation);
	REGISTER_USER_FUNC(arwQueryMarkerTransformationStereo);
	REGISTER_USER_FUNC(arwLoadOpticalParams);
	REGISTER_USER_FUNC(ReAllocTexture);
	REGISTER_USER_FUNC(OpenStream);
	REGISTER_USER_FUNC(GetPicWidth);
	REGISTER_USER_FUNC(GetPicHeight);
	REGISTER_USER_FUNC(GetPicX);
	REGISTER_USER_FUNC(GetPicY);
	REGISTER_USER_FUNC(DecodeFrame);
	REGISTER_USER_FUNC(GetYStride);
	REGISTER_USER_FUNC(GetYHeight);
	REGISTER_USER_FUNC(GetUVStride);
	REGISTER_USER_FUNC(GetUVHeight);
	REGISTER_USER_FUNC(DecodeAndUpload);
	REGISTER_USER_FUNC(GetPlane);
	REGISTER_USER_FUNC(GetNextFrameTime);
	REGISTER_USER_FUNC(CloseStream);
	REGISTER_USER_FUNC(GetAspectRatio);
}
