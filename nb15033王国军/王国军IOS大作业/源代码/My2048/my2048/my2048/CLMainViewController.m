...
-(void)createButtons
{
    ...
    _scoreButton.backgroundColor=[UIColor colorWithRed:187/255.0 green:173/255.0 blue:160/255.0 alpha:1.0];
    ...
    _bestScoreButton.backgroundColor=[UIColor colorWithRed:187/255.0 green:173/255.0 blue:160/255.0 alpha:1.0];
...
-(void)addBackGround
{
    ...
    self.view.backgroundColor=[UIColor colorWithRed:251/255.0 green:248/255.0 blue:239/255.0 alpha:1];
    ...
    CGContextSetRGBStrokeColor(UIGraphicsGetCurrentContext(), 189/255.0, 172/255.0, 162/255.0, 1.0);
