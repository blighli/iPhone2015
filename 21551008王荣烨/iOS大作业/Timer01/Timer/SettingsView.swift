...
final class SettingsView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        workInputHostView.nameLabel.text = NSLocalizedString("工作时长", comment: "Settings name for the work duration")
        workInputHostView.tag = 0
        
        breakInputHostView = InputHostView(frame: CGRectZero)
        breakInputHostView.nameLabel.text = NSLocalizedString("休息时长", comment: "Settings name for the break duration")
