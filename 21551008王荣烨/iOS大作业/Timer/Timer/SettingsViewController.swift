...
final class SettingsViewController: UIViewController {
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        let doneButton = UIBarButtonItem(title: "退出", style: .Plain, target: self, action: "dismissSettings")
        navigationItem.rightBarButtonItem = doneButton
        
        settingsView.setWorkDurationString("\(currentWorkDurationInMinutes) 分")
        settingsView.setBreakDurationString("\(currentBreakDurationInMinutes) 分")
...
extension SettingsViewController : UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    func pickerView(pickerView: UIPickerView, attributedTitleForRow row: Int, forComponent component: Int) -> NSAttributedString? {
        ...
        let attributedTitle = NSAttributedString(string: "\(minutes) 分", attributes: [NSForegroundColorAttributeName : UIColor.yellowColor()])
    ...
    func pickerView(pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        let timerType = settingsView.setDurationString("\(minutes) 分")
