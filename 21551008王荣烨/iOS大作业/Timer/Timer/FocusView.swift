...
final class FocusView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        workButton = makeButton(NSLocalizedString("工作模式", comment: "Start working button title"))
        breakButton = makeButton(NSLocalizedString("休息模式", comment: "Start break button title"))
        
        procrastinateButton = makeButton(NSLocalizedString("放松模式", comment: "Start procratination button title"))
        if let font = workButton.titleLabel?.font {
            workButton.titleLabel?.font = font.fontWithSize(14)
        }
        if let font = breakButton.titleLabel?.font {
            breakButton.titleLabel?.font = font.fontWithSize(14)
        }
        
        if let font = procrastinateButton.titleLabel?.font {
            procrastinateButton.titleLabel?.font = font.fontWithSize(14)
        }
